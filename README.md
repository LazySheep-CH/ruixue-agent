...
检索指标由 150 题评测集测出(合成 + 人工质检 + TREC pooling),方法见 `docs/评测方法.md`。
...
- [docs/面试问答卡.md](docs/面试问答卡.md) — **一问一答,用来背**(全项目 80+ 题)
- [docs/面试准备.md](docs/面试准备.md) — 按「面试怎么问」重组的项目全景:9 条追问链 + 真实数字 + 边界
